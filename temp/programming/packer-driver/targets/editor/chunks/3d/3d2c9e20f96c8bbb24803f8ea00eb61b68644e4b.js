System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Vec3, Input, Animation, Node, GameManager, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, PlayerController;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Vec3', 'input', 'Input', 'EventMouse', 'Animation', 'SkeletalAnimation', 'EventTouch', 'Node', 'GameManager']);
      ...
      _export("PlayerController", PlayerController = (_dec = ccclass("PlayerController"), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property({
        type: Animation
      }), _dec5 = property({
        type: GameManager
        ...
        constructor(...args) {
          ...
          _initializerDefineProperty(this, "BodyAnim", _descriptor3, this);

          // 关联 GameManager 组件
          _initializerDefineProperty(this, "gameMg", _descriptor4, this);
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "BodyAnim", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "gameMg", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=3d2c9e20f96c8bbb24803f8ea00eb61b68644e4b.js.map