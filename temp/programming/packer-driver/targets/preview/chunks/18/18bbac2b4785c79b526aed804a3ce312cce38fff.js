System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      GameType = /*#__PURE__*/function (GameType) {
        GameType[GameType["NORMAL"] = 0] = "NORMAL";
        GameType[GameType["LIMIT_TIME"] = 1] = "LIMIT_TIME";
        GameType[GameType["END_LESS"] = 2] = "END_LESS";
        return GameType;
      }(GameType || {});
      ...
      _export("GameManager", GameManager = (_dec = ccclass("GameManager"), _dec2 = property({
        ...
        generateRoad() {
          ...
          this._road = [];
          this.currentBlockIndex = 0; // 确保游戏运行时，人物一定站在实路上
        ...
        onPlayerJumpEnd(moveIndex) {
          if (this.stepsLabel || this.curGameType === GameType.NORMAL) {
          ...
          this.checkResult(moveIndex); // 普通模式退出
          ...
          if (moveIndex >= 25) {
            // 更新当前格子索引
            this.currentBlockIndex++; // 删除第一个格子

            if (this._road[moveIndex - 25] === BlockType.BT_STONE) {
              var firstBlock = this.node.children[0];
            ...
            var blockType; // 随机生成块类型，0 表示坑，1 表示石头
            ...
            var block = this.spawnBlockByType(blockType);

            if (block) {
              this.node.addChild(block);
              block.setPosition(moveIndex - 25, -1.5, 0);
            }
          }
        }
...
//# sourceMappingURL=18bbac2b4785c79b526aed804a3ce312cce38fff.js.map