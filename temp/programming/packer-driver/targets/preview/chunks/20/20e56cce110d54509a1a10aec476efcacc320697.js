    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass("GameManager"), _dec2 = property({
        ...
        onPlayerJumpEnd(moveIndex) {
          ...
          this.checkResult(moveIndex); // 非普通模式下
        ...
        refreshCube(moveIndex) {
          // 非普通模式下，当移动到当前格子索引大于25时
          if (moveIndex >= 25) {
            // 更新当前格子索引
            this.currentBlockIndex++; // 添加新格子
...
//# sourceMappingURL=20e56cce110d54509a1a10aec476efcacc320697.js.map