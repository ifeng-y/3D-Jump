  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass("GameManager"), _dec2 = property({
        ...
        //         const blockType = Math.floor(Math.random() * 2); // 随机生成块类型，0 表示坑，1 表示石头
        ...
        onPlayerJumpEnd(moveIndex) {
          ...
          if (moveIndex >= 25) {
            ...
            if (this._road[this._road.length - 2] === BlockType.BT_NONE) {
...
//# sourceMappingURL=ac0beb80c915a72decae0f5f206a85401afe4951.js.map